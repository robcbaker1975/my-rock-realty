    ...
    <section className="relative bg-gradient-to-b from-charcoal/95 via-charcoal to-charcoal/98 py-24 sm:py-32 md:py-40">
      ...
      <div className="relative container mx-auto w-full max-w-4xl px-6 sm:px-8">
        ...
        <motion.div
          ...
          className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-6 mb-16 sm:mb-20"
        >
          {/* Buying Path */}
          <div className="p-8 sm:p-7 rounded-lg border border-gold/25 bg-gold/8 hover:bg-gold/12 transition-colors duration-300">
            <h3 className="text-xl sm:text-lg font-bold text-white mb-4" style={{ fontFamily: "'Outfit', sans-serif" }}>
              Buying a Home
            </h3>
            <p className="text-base sm:text-[15px] text-white/75 mb-6 leading-relaxed">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 text-gold hover:text-gold-light font-semibold text-base transition-colors"
            >
              Help Me Buy Smarter
              <ArrowRight size={18} />
            </button>
