...
export default function HomeFinalCTASection() {
  ...
  return (
    <section className="py-14 sm:py-20 md:py-24 bg-charcoal border-t border-white/8">
      <div className="container">
        <div className="max-w-2xl">
          ...
          <motion.p
            ...
            className="text-cream/60 text-base sm:text-lg leading-relaxed mb-8 sm:mb-10"
          ...
          >
            ...
            <a
              href="tel:7203636544"
              className="inline-flex items-center justify-center gap-2.5 px-7 py-4 border border-cream/25 text-cream font-semibold rounded-lg transition-all hover:border-cream/50 hover:bg-white/5 text-[15px] sm:text-base no-underline"
              style={{ fontFamily: "'Outfit', sans-serif" }}
            >
