...
function CTAButton({ className = "" }: { className?: string }) {
  return (
    <a
      href="#joinus-contact"
      onClick={(e: React.MouseEvent) => { e.preventDefault(); document.getElementById('joinus-contact')?.scrollIntoView({ behavior: 'smooth' }); }}
  ...
  return (
    <div className="hub-page min-h-screen bg-warm-white">
      ...
      <section className="py-14 sm:py-20 bg-warm-white">
        <div className="container max-w-4xl">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <h2
              className="text-lg sm:text-3xl font-bold text-charcoal text-center mb-10 leading-tight"
              style={{ fontFamily: "'Outfit', sans-serif" }}
            >
      ...
      {/* ═══════════════════════════════════════════════════
          AGENT INQUIRY FORM
      ═══════════════════════════════════════════════════ */}
      <section id="joinus-contact" className="py-12 sm:py-16 md:py-20 bg-warm-white border-t border-gold/10">
        <div className="container max-w-3xl">
          {submitted ? (
            <motion.div
            ...
            >
              ...
              >
                ...
                <div className="grid sm:grid-cols-2 gap-4 sm:gap-5">
                  ...
                  <div>
                    <label htmlFor="joinus-license-status" className="block text-charcoal/70 text-sm font-medium mb-2" style={{ fontFamily: "'Outfit', sans-serif" }}>
                      License Status
                    </label>
                    <select
                      id="joinus-license-status"
                      value={formData.type}
