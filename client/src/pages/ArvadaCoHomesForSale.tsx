/**
 * Arvada CO Homes for Sale — My Rock Realty
 * Denver suburb spoke page — focused suburb page for Arvada search intent
...
const faqContent = [
  {
    question: "What is Arvada known for in the Denver metro area?",
    answer:
      "Arvada is known for its suburban setting, established residential areas, community amenities, and a range of housing options for buyers looking outside central Denver.",
  },
  {
    question: "What types of homes can buyers find in Arvada?",
    answer:
  ...
  {
    question: "Why do buyers consider Arvada when searching in the Denver metro area?",
    answer:
      "Buyers often consider Arvada for its suburban character, neighborhood variety, access to amenities, and its position within the broader Denver-area market.",
  },
  {
    question: "Is Arvada a good fit for buyers who want a suburban setting?",
    answer:
      "Arvada can be a strong fit for buyers who want a more suburban environment with residential neighborhoods, community amenities, and a different pace from central Denver.",
  },
  {
    question: "What should buyers pay attention to when considering homes in Arvada?",
    answer:
      "Buyers should pay attention to neighborhood differences, commute patterns, home age and condition, community layout, nearby amenities, and how one part of Arvada compares with another.",
  },
];
...
const breadcrumbItems = [
  { label: "Home", url: "/" },
  { label: "Arvada CO Homes for Sale", url: "/arvada-co-homes-for-sale" },
];
...
function CTAButton({
  label = "Schedule an Arvada Home Buying Consultation",
  className = "",
}: {
  label?: string;
  className?: string;
  ...
  return (
    <a
      href="mailto:rob@myrockhomes.com?subject=Arvada Home Buying Consultation"
...
export default function ArvadaCoHomesForSale() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-cream">
      ...
      {/* ═══════════════════════════════════════════════════
          1. HERO — Arvada CO Homes for Sale
      ═══════════════════════════════════════════════════ */}
        ...
        <div className="container relative z-10 py-16 sm:py-20 md:py-24">
          ...
          >
            ...
            <p className="text-lg text-cream/80 mb-8 leading-relaxed">
              Explore homes in Arvada — an established suburban community in the
              Denver metro area. Residential neighborhoods, community amenities,
              and a range of housing options make Arvada an attractive choice for
              buyers seeking a suburban setting outside central Denver.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <CTAButton />
              <a
                href="mailto:rob@myrockhomes.com?subject=Arvada Listings — Alert Request"
                ...
                style={{ fontFamily: "'Outfit', sans-serif" }}
              >
                Get Alerts for New Arvada Homes
                <ArrowRight size={18} />
              </a>
            </div>
          </motion.div>
      ...
      <section className="py-16 sm:py-20 bg-cream">
        <div className="container">
          <h2
            ...
            style={{ fontFamily: "'Outfit', sans-serif" }}
          >
            Why Buyers Consider Arvada
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                icon: Home,
                title: "Established Suburban Setting",
                desc: "Arvada offers an established suburban environment with residential neighborhoods, community amenities, and a different pace from central Denver.",
              },
              {
                icon: MapPin,
              ...
              },
              {
                ...
                desc: "Arvada's position within the broader Denver-area market provides suburban character with access to everyday amenities and employment centers.",
              },
            ].map((item, idx) => (
              <motion.div
                key={idx}
        ...
        <div className="container max-w-2xl">
          ...
          >
            <p className="text-cream/90 leading-relaxed mb-6">
              Arvada has a recognizable suburban identity built around established
              residential areas, community amenities, and a range of housing
              choices. Buyers are drawn to the community's suburban character,
              neighborhood variety, and access to everyday amenities within the
              broader Denver metro area.
            </p>
      ...
      {/* ═══════════════════════════════════════════════════
          4. Homes and Housing Styles in Arvada
      ═══════════════════════════════════════════════════ */}
      <section className="py-16 sm:py-20 bg-cream">
        <div className="container">
          <h2
            ...
            style={{ fontFamily: "'Outfit', sans-serif" }}
          >
            Homes and Housing Styles in Arvada
          </h2>
      ...
      <section className="py-16 sm:py-20 bg-charcoal">
        <div className="container max-w-2xl">
          <h2
            ...
            style={{ fontFamily: "'Outfit', sans-serif" }}
          >
            What to Know Before Buying in Arvada
          </h2>
          <div className="space-y-4">
            {[
              "Pay attention to neighborhood differences throughout Arvada",
              ...
              "Compare one part of Arvada with another",
              "Consider school districts and community services if applicable",
              "Work with an agent familiar with Arvada's specific market dynamics",
            ].map((item, idx) => (
              <motion.div
                key={idx}
                initial="hidden"
      ...
      {/* ═══════════════════════════════════════════════════
          6. Explore Arvada Real Estate Options
      ═══════════════════════════════════════════════════ */}
      <section className="py-16 sm:py-20 bg-cream">
        <div className="container">
          <h2
            ...
            style={{ fontFamily: "'Outfit', sans-serif" }}
          >
            Explore Arvada Real Estate Options
          </h2>
      ...
      <section className="py-16 sm:py-20 bg-charcoal">
        <div className="container max-w-2xl">
          ...
          >
            <p className="text-cream/90 leading-relaxed mb-6">
              Buying in Arvada involves understanding the community's specific
              market dynamics, housing mix, and how individual properties compare
              within the area. Knowing the Denver-area buying process helps
        ...
        <div className="container max-w-2xl text-center">
          <motion.div initial="hidden" whileInView="visible" variants={fadeUp}>
            <h2
              ...
              style={{ fontFamily: "'Outfit', sans-serif" }}
            >
              Ready to Explore Arvada Homes?
            </h2>
            <p className="text-lg text-cream/80 mb-8">
              Schedule a consultation to discuss your Arvada home buying goals
