 ...
 * Denver neighborhood spoke page — focused neighborhood page for LoHi search intent
...
const faqContent = [
  {
    question: "What is LoHi known for in Denver?",
    answer:
      "LoHi is known for its central location, neighborhood identity, active dining and social scene, and mix of residential options near some of Denver's most recognizable urban areas.",
  },
  {
    question: "What types of homes can buyers find in LoHi?",
    answer:
      "Buyers may find a mix of newer homes, attached properties, townhomes, condos, and other housing styles depending on the block and part of the neighborhood.",
  },
  {
    question: "Why do buyers consider LoHi when searching in Denver?",
    answer:
      "Buyers often consider LoHi for its location, urban energy, neighborhood visibility, and access to dining, entertainment, and nearby Denver districts.",
  },
  {
    question: "Is LoHi a good fit for buyers who want an active urban neighborhood?",
    answer:
      "LoHi can be a strong fit for buyers who want an established neighborhood identity with a more active, connected feel and convenient access to surrounding city amenities.",
  },
  {
    question: "What should buyers pay attention to when considering homes in LoHi?",
    answer:
      "Buyers should pay attention to block-by-block differences, home style, traffic patterns, nearby commercial activity, parking considerations, and how a property compares with other options in the area.",
  },
];
...
function CTAButton({
  label = "Schedule a LoHi Home Buying Consultation",
  className = "",
}: {
  label?: string;
  className?: string;
  ...
  return (
    <a
      href="mailto:rob@myrockhomes.com?subject=LoHi Home Buying Consultation"
...
export default function LohiDenverHomesForSale() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-cream">
      ...
      {/* ═══════════════════════════════════════════════════
          1. HERO — LoHi Denver Homes for Sale
      ═══════════════════════════════════════════════════ */}
        ...
        <div className="container relative z-10 py-16 sm:py-20 md:py-24">
          ...
          >
            ...
            <p className="text-lg text-cream/80 mb-8 leading-relaxed">
              Explore homes in LoHi — Denver's Lower Highlands neighborhood.
              Active dining scene, urban energy, and central location make
              LoHi a consistent draw for buyers seeking a connected Denver
              address.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <CTAButton />
              <a
                href="mailto:rob@myrockhomes.com?subject=LoHi Listings — Alert Request"
      ...
      <section className="py-16 sm:py-20 bg-cream">
        <div className="container">
          <h2
            ...
            style={{ fontFamily: "'Outfit', sans-serif" }}
          >
            Why Buyers Consider LoHi
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                icon: Zap,
                title: "Urban Energy and Identity",
                desc: "LoHi has a strong neighborhood identity with an active dining and social scene, making it a draw for buyers who want a connected, energetic Denver address.",
              },
              {
                icon: Home,
                title: "Diverse Housing Options",
                desc: "Buyers may find newer homes, attached properties, townhomes, condos, and other housing styles depending on the block and part of the neighborhood.",
              },
              {
                icon: MapPin,
                title: "Central Denver Location",
                desc: "LoHi's central position provides easy access to downtown Denver, nearby districts, dining, entertainment, and surrounding city amenities.",
              },
            ].map((item, idx) => (
              <motion.div
                key={idx}
        ...
        <div className="container max-w-2xl">
          ...
          >
            <p className="text-cream/90 leading-relaxed mb-6">
              LoHi has a recognizable identity built around its central
              location, active dining scene, and urban neighborhood character.
              Buyers are drawn to the neighborhood's combination of energy,
              visibility, and convenient access to surrounding Denver areas.
            </p>
            <p className="text-cream/90 leading-relaxed">
              The neighborhood attracts a range of buyers — from those
              prioritizing urban lifestyle and walkability to buyers comparing
              central Denver neighborhoods for long-term value and
              neighborhood fit.
            </p>
          </motion.div>
        </div>
      ...
      {/* ═══════════════════════════════════════════════════
          4. Homes and Housing Styles in LoHi
      ═══════════════════════════════════════════════════ */}
      <section className="py-16 sm:py-20 bg-cream">
        <div className="container">
          <h2
            ...
            style={{ fontFamily: "'Outfit', sans-serif" }}
          >
            Homes and Housing Styles in LoHi
          </h2>
      ...
      {/* ═══════════════════════════════════════════════════
          5. What to Know Before Buying in LoHi
      ═══════════════════════════════════════════════════ */}
      <section className="py-16 sm:py-20 bg-charcoal">
        <div className="container max-w-2xl">
          <h2
            ...
            style={{ fontFamily: "'Outfit', sans-serif" }}
          >
            What to Know Before Buying in LoHi
          </h2>
          <div className="space-y-4">
            {[
              "Pay attention to block-by-block differences within the neighborhood",
              "Evaluate home style and condition carefully",
              "Understand traffic patterns and nearby commercial activity",
              "Review parking considerations for the specific property",
              "Compare the property with other options in the area",
              "Consider how nearby uses and street activity align with your lifestyle",
              "Work with an agent familiar with LoHi's specific market dynamics",
            ].map((item, idx) => (
              <motion.div
                key={idx}
                initial="hidden"
      ...
      {/* ═══════════════════════════════════════════════════
          6. Explore LoHi Real Estate Options
      ═══════════════════════════════════════════════════ */}
      <section className="py-16 sm:py-20 bg-cream">
        <div className="container">
          <h2
            ...
            style={{ fontFamily: "'Outfit', sans-serif" }}
          >
            Explore LoHi Real Estate Options
          </h2>
      ...
      <section className="py-16 sm:py-20 bg-charcoal">
        <div className="container max-w-2xl">
          ...
          >
            <p className="text-cream/90 leading-relaxed mb-6">
              Buying in LoHi involves understanding the neighborhood's
        ...
        <div className="container max-w-2xl text-center">
          ...
          >
            <h2
              ...
              style={{ fontFamily: "'Outfit', sans-serif" }}
            >
              Ready to Explore LoHi Homes?
            </h2>
            <p className="text-lg text-cream/80 mb-8">
              Schedule a consultation to discuss your LoHi home buying goals
              and explore available options in Denver's Lower Highlands.
            </p>
