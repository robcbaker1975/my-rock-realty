/**
 * Peterson SFB Relocation Guide — My Rock Realty
...
const faqContent = [
  {
    question: "What communities do buyers relocating to Peterson SFB typically consider?",
    answer:
      "Peterson SFB is located on the east side of Colorado Springs. Buyers commonly look at east Colorado Springs neighborhoods, Falcon, Peyton, and Schriever-adjacent communities. The right fit depends on commute preferences, school priorities, and budget.",
  },
  {
    question: "Is Peterson SFB close to Schriever SFB?",
    answer:
      "Peterson SFB and Schriever SFB are both in the Colorado Springs area. Some buyers assigned to one installation consider communities that provide reasonable access to both, depending on their situation.",
  },
  {
    question: "Can Rob help me buy near Peterson SFB if I'm still out of state?",
    answer:
...
const orientationPoints = [
  {
    ...
    text: "Peterson SFB sits on the east side of Colorado Springs near Colorado Springs Airport. Buyers typically look at east-side neighborhoods, Falcon, and Peyton for shorter commutes, as well as central Colorado Springs for more urban amenities.",
  },
  {
    icon: Home,
...
export default function PetersonSpaceForceBase() {
  ...
  return (
    <div className="min-h-screen bg-cream" style={{ fontFamily: "'Libre Franklin', sans-serif" }}>
      <SeoHead
        metadata={{
          title: "Peterson SFB Relocation Guide | Colorado Springs Real Estate | My Rock Realty",
      ...
      >
        ...
        <div className="container relative">
          ...
          <motion.h1
            ...
            style={{ fontFamily: "'Outfit', sans-serif" }}
          >
            Relocating to <span className="text-gold">Peterson SFB</span>
          </motion.h1>
          <motion.p
          ...
          >
            <a
              ...
              style={{ fontFamily: "'Outfit', sans-serif" }}
            >
              Talk to Rob About Peterson SFB
      ...
      <section className="py-12 sm:py-20 bg-white">
        <div className="container">
          ...
          >
            Peterson SFB buyers face compressed timelines and an unfamiliar market. Understanding
      ...
      <section className="py-12 sm:py-20 bg-cream">
        <div className="container">
          <motion.h2
            ...
            style={{ fontFamily: "'Outfit', sans-serif" }}
          >
            Communities Near Peterson SFB
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
            className="text-charcoal-light/70 text-[15px] sm:text-base leading-relaxed max-w-2xl mb-8"
          >
            Buyers relocating to Peterson SFB typically consider communities on the east side of
            Colorado Springs and surrounding areas.
          </motion.p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { name: "East Colorado Springs", note: "Closest to Peterson SFB with a range of established neighborhoods and price points." },
              ...
              { name: "Schriever-Adjacent", note: "If dual-installation access matters, communities between Peterson and Schriever SFB." },
            ].map((c, i) => (
              <motion.div
                key={c.name}
      ...
      <section className="py-12 sm:py-20 bg-cream">
        <div className="container max-w-3xl">
          <motion.h2
            ...
            style={{ fontFamily: "'Outfit', sans-serif" }}
          >
            Common Questions — Peterson SFB Relocation
          </motion.h2>
      ...
      <section id="contact-rob" className="py-12 sm:py-20 bg-charcoal">
        <div className="container max-w-2xl text-center">
          <motion.h2
            ...
            style={{ fontFamily: "'Outfit', sans-serif" }}
          >
            Ready to Plan Your Peterson SFB Move?
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
