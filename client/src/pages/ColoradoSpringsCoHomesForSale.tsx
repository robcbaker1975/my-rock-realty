...
export default function ColoradoSpringsCoHomesForSale() {
  ...
  return (
    <div className="min-h-screen bg-warm-white">
      ...
      {/* ═══════════════════════════════════════════════════
          11. FEATURED COLORADO SPRINGS LISTINGS (FUTURE IDX PLACEHOLDER)
      ═══════════════════════════════════════════════════ */}
      <section className="py-14 sm:py-16 bg-charcoal/3">
        <div className="container max-w-4xl mx-auto">
          <h2
          ...
          <div className="bg-charcoal/4 border-2 border-dashed border-charcoal/20 rounded-lg p-10 text-center">
            ...
            <p className="text-xs text-charcoal/30">
              Live MLS listings for Colorado Springs homes will appear here once IDX integration is configured.
            </p>
          </div>
          {/* ── END IDX PLACEHOLDER ── */}
        </div>
