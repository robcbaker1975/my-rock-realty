...
async function prerenderPineCreek() {
  ...
  const _seoBlock = buildSeoHeadBlock({
    ...
    description: 'Thinking about living in Pine Creek, Colorado Springs? Learn what Pine Creek is actually like, who it fits, the real tradeoffs, and how it compares with Briargate and Flying Horse.',
  ...
  console.log(`[prerender-pine-creek] Sanity: rootNotEmpty=${rootNotEmpty}, hasH1=${hasH1}, anchors=${anchorCount}`);
